...
import com.ojasx.FinTrack.CalculatorWorking.CalculatorScreen.Category.CardComposable.CardStructure
import com.ojasx.FinTrack.R
import com.ojasx.FinTrack.ui.theme.warmwhite
import androidx.compose.foundation.lazy.LazyColumn
import androidx.compose.foundation.lazy.items
import com.ojasx.FinTrack.CalculatorWorking.CalculatorScreen.Category.CardComposable.getHousingCards


@Composable
fun Housing(navController: NavController,
    ...
    Box(
        ...
        Column(
            ...
            Row(
                ...
                Image(
                    painter = painterResource(R.drawable.housing),
                    contentDescription = "",
                    Modifier.size(50.dp)
                )
                Spacer(modifier = Modifier.width(8.dp))
