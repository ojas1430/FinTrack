...
class BorrowedViewModel : ViewModel() {
    ...
    private val _budgets = MutableLiveData<List<BorrowedCard>>(emptyList())
    val budgets : LiveData<List<BorrowedCard>> = _budgets

    fun saveBudget(){
        val newBudget = BorrowedCard(
            name = _name.value ?: "",
