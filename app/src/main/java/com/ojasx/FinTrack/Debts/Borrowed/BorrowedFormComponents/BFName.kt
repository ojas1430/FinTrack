...
@Composable
fun BFName(borrowedViewModel: BorrowedViewModel) {
    // observe the current name from ViewModel
    val name by borrowedViewModel.name.observeAsState(initial = "")
    ...
    Column(
        ...
        BasicTextField(
            ...
            onValueChange = { newValue ->
                borrowedViewModel.updateName(newValue)
            },
            singleLine = true,
            ...
            decorationBox = { innerTextField ->
                Column {
                    ...
                    if (name.isEmpty() && !isFocused) {
                        Text(
                            text = "From whom you have borrowed?",
